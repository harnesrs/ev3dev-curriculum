...
# done. Get a yardstick or tape measure to do some testing with /examples/motors/drive_input_speed.py
...
#
# done. Copy the content of the /examples/motors/drive_input_speed.py program and place it below these comments.
#   Change the initial print and speak commands to reflect this module, like this...
#    print("--------------------------------------------")
#    print("  Timed Driving")
#    print("--------------------------------------------")
#    ev3.Sound.speak("Timed Driving").wait()
# done. Change the input questions from:
...
# done. Modify the program so that it will exit immediately if the answer to   any   question is 0.
# done. Formally test your work. When you think you have the problem complete run these tests to be sure:
