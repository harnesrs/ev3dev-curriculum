...
# Also someone should update the libs/mqtt_remote_method_calls.py file on the robot too (at some point before Pang).
...
def left_mouse_click(event, mqtt_client):
    ...
    mqtt_client.send_message('on_circle_draw', [my_color])
